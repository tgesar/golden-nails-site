...
const servicesData = {
  'Manicure/Pedicure': {
    ...
    services: [
      { name: 'Basic Manicure', price: '$32' },
      { name: 'Basic Manicure Gel', price: '$42' },
  ...
  'Add-ons': {
    ...
    services: [
      ...
      { name: 'Regular Nail Polish Change', price: '$15+' },
